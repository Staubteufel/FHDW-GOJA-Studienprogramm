...
public class StudentServerICProxi extends ServiceICProxi implements PersistentStudentServer{
    
    public StudentServerICProxi(long objectId) {
        super(objectId);
    }
    public StudentServerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStudentServerFacade
            .getStudentServer(this.getId());
    }
