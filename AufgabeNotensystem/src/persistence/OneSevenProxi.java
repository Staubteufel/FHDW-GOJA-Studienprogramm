...
public class OneSevenProxi extends ThirdMarkProxi implements PersistentOneSeven{
    
    public OneSevenProxi(long objectId) {
        super(objectId);
    }
    public OneSevenProxi(PersistentInCacheProxi object) {
        super(object);
    }
