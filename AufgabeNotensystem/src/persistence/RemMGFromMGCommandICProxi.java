...
public class RemMGFromMGCommandICProxi extends PersistentInCacheProxi implements PersistentRemMGFromMGCommand{
    
    public RemMGFromMGCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemMGFromMGCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemMGFromMGCommandFacade
            .getRemMGFromMGCommand(this.getId());
    }
