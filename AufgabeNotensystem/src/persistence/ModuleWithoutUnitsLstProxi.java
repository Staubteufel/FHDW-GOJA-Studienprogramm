...
public class ModuleWithoutUnitsLstProxi extends PersistentProxi implements PersistentModuleWithoutUnitsLst{
    
    public ModuleWithoutUnitsLstProxi(long objectId) {
        super(objectId);
    }
    public ModuleWithoutUnitsLstProxi(PersistentInCacheProxi object) {
        super(object);
    }
