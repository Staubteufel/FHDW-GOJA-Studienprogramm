...
public class RemMGFromSPCommandProxi extends PersistentProxi implements PersistentRemMGFromSPCommand{
    
    public RemMGFromSPCommandProxi(long objectId) {
        super(objectId);
    }
    public RemMGFromSPCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
