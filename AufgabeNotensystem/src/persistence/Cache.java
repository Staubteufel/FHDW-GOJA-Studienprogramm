...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(160, "AddMGToMGCommand");
		this.number2NameMap.put(174, "AddMGToSPCommand");
		this.number2NameMap.put(171, "AddMWUToMGCommand");
		this.number2NameMap.put(175, "AddMWWUToMGCommand");
		this.number2NameMap.put(179, "AddSToSGCommand");
		this.number2NameMap.put(183, "AddUToMWUCommand");
		this.number2NameMap.put(-201, "AdminServer");
		this.number2NameMap.put(119, "BooleanMark");
		this.number2NameMap.put(233, "BooleanMarkLst");
		this.number2NameMap.put(249, "ChangeCPCommand");
		this.number2NameMap.put(-110, "CommandCoordinator");
		this.number2NameMap.put(-123, "CommandExecuter");
		this.number2NameMap.put(122, "CommonDate");
		this.number2NameMap.put(168, "CreateMWUCommand");
		this.number2NameMap.put(165, "CreateMWWUCommand");
		this.number2NameMap.put(182, "CreateModuleGroupCommand");
		this.number2NameMap.put(166, "CreateStudentCommand");
		this.number2NameMap.put(180, "CreateStudyGroupCommand");
		this.number2NameMap.put(178, "CreateStudyProgramCommand");
		this.number2NameMap.put(161, "CreateUnitCommand");
		this.number2NameMap.put(-104, "ErrorDisplay");
		this.number2NameMap.put(227, "Failed");
		this.number2NameMap.put(157, "FetchMCommand");
		this.number2NameMap.put(211, "FetchStudentMCommand");
		this.number2NameMap.put(215, "FiveZero");
		this.number2NameMap.put(224, "FourZero");
		this.number2NameMap.put(247, "MarkFactory");
		this.number2NameMap.put(121, "MarkHistoryEntry");
		this.number2NameMap.put(105, "ModuleGroup");
		this.number2NameMap.put(205, "ModuleGroupLst");
		this.number2NameMap.put(114, "ModuleWithUnits");
		this.number2NameMap.put(206, "ModuleWithUnitsLst");
		this.number2NameMap.put(108, "ModuleWithoutUnits");
		this.number2NameMap.put(209, "ModuleWithoutUnitsLst");
		this.number2NameMap.put(115, "NoneMark");
		this.number2NameMap.put(220, "OneSeven");
		this.number2NameMap.put(222, "OneThree");
		this.number2NameMap.put(225, "OneZero");
		this.number2NameMap.put(226, "Passed");
		this.number2NameMap.put(163, "RemMGFromMGCommand");
		this.number2NameMap.put(167, "RemMGFromSPCommand");
		this.number2NameMap.put(181, "RemMWUFromMGCommand");
		this.number2NameMap.put(170, "RemMWWUFromMGCommand");
		this.number2NameMap.put(162, "RemUFromMWUCommand");
		this.number2NameMap.put(242, "RemoveModuleGroupCommand");
		this.number2NameMap.put(243, "RemoveStudyGroupCommand");
		this.number2NameMap.put(241, "RemoveStudyProgramCommand");
		this.number2NameMap.put(239, "RemoveUnitCommand");
		this.number2NameMap.put(240, "RmvMWOUCommand");
		this.number2NameMap.put(238, "RmvMWUCommand");
		this.number2NameMap.put(-141, "Server");
		this.number2NameMap.put(176, "SetActiveSGCommand");
		this.number2NameMap.put(173, "SorcMTSWiMWuUCommand");
		this.number2NameMap.put(177, "SorcMTSWiUCommand");
		this.number2NameMap.put(-200, "StudentServer");
		this.number2NameMap.put(228, "StudentServerLst");
		this.number2NameMap.put(111, "StudyGroup");
		this.number2NameMap.put(204, "StudyGroupLst");
		this.number2NameMap.put(116, "StudyProgram");
		this.number2NameMap.put(207, "StudyProgramLst");
		this.number2NameMap.put(112, "TenthMark");
		this.number2NameMap.put(124, "ThirdMark");
		this.number2NameMap.put(229, "ThirdMarkLst");
		this.number2NameMap.put(217, "ThreeSeven");
		this.number2NameMap.put(221, "ThreeThree");
		this.number2NameMap.put(218, "ThreeZero");
		this.number2NameMap.put(219, "TwoSeven");
		this.number2NameMap.put(223, "TwoThree");
		this.number2NameMap.put(216, "TwoZero");
		this.number2NameMap.put(106, "Unit");
		this.number2NameMap.put(203, "UnitLst");	
	}
