...
public abstract class MarkNotCalculableProxi extends PersistentProxi implements PersistentMarkNotCalculable{
    
    public MarkNotCalculableProxi(long objectId) {
        super(objectId);
    }
    public MarkNotCalculableProxi(PersistentInCacheProxi object) {
        super(object);
    }
