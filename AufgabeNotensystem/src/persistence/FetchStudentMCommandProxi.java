...
public class FetchStudentMCommandProxi extends PersistentProxi implements PersistentFetchStudentMCommand{
    
    public FetchStudentMCommandProxi(long objectId) {
        super(objectId);
    }
    public FetchStudentMCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
