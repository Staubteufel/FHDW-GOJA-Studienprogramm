...
public class AddMWWUToMGCommandICProxi extends PersistentInCacheProxi implements PersistentAddMWWUToMGCommand{
    
    public AddMWWUToMGCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddMWWUToMGCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddMWWUToMGCommandFacade
            .getAddMWWUToMGCommand(this.getId());
    }
