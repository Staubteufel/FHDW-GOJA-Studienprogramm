...
public class OneThreeICProxi extends ThirdMarkICProxi implements PersistentOneThree{
    
    public OneThreeICProxi(long objectId) {
        super(objectId);
    }
    public OneThreeICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theOneThreeFacade
            .getOneThree(this.getId());
    }
