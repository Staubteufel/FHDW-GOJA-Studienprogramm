...
public abstract class ApprICProxi extends PrototypeICProxi implements PersistentAppr{
    
    public ApprICProxi(long objectId) {
        super(objectId);
    }
    public ApprICProxi(PersistentObject object) {
        super(object);
    }
