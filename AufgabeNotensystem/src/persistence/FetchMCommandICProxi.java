...
public class FetchMCommandICProxi extends PersistentInCacheProxi implements PersistentFetchMCommand{
    
    public FetchMCommandICProxi(long objectId) {
        super(objectId);
    }
    public FetchMCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theFetchMCommandFacade
            .getFetchMCommand(this.getId());
    }
