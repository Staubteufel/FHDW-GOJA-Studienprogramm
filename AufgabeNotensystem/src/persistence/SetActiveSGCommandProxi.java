...
public class SetActiveSGCommandProxi extends PersistentProxi implements PersistentSetActiveSGCommand{
    
    public SetActiveSGCommandProxi(long objectId) {
        super(objectId);
    }
    public SetActiveSGCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
