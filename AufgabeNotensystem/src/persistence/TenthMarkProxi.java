...
public class TenthMarkProxi extends MarkCalculableProxi implements PersistentTenthMark{
    
    public TenthMarkProxi(long objectId) {
        super(objectId);
    }
    public TenthMarkProxi(PersistentInCacheProxi object) {
        super(object);
    }
