...
public class StudyProgramProxi extends ApprProxi implements PersistentStudyProgram{
    
    public StudyProgramProxi(long objectId) {
        super(objectId);
    }
    public StudyProgramProxi(PersistentInCacheProxi object) {
        super(object);
    }
