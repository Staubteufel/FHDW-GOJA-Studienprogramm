...
public class AddMGToSPCommandProxi extends PersistentProxi implements PersistentAddMGToSPCommand{
    
    public AddMGToSPCommandProxi(long objectId) {
        super(objectId);
    }
    public AddMGToSPCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
