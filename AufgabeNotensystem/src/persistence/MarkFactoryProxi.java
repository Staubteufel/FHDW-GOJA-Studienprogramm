...
public class MarkFactoryProxi extends PersistentProxi implements PersistentMarkFactory{
    
    public MarkFactoryProxi(long objectId) {
        super(objectId);
    }
    public MarkFactoryProxi(PersistentInCacheProxi object) {
        super(object);
    }
