...
public class AddUToMWUCommandICProxi extends PersistentInCacheProxi implements PersistentAddUToMWUCommand{
    
    public AddUToMWUCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddUToMWUCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddUToMWUCommandFacade
            .getAddUToMWUCommand(this.getId());
    }
