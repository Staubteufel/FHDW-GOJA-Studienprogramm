...
public class AddSToSGCommandICProxi extends PersistentInCacheProxi implements PersistentAddSToSGCommand{
    
    public AddSToSGCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddSToSGCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddSToSGCommandFacade
            .getAddSToSGCommand(this.getId());
    }
