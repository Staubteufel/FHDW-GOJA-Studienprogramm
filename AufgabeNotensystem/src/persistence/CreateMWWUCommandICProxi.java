...
public class CreateMWWUCommandICProxi extends PersistentInCacheProxi implements PersistentCreateMWWUCommand{
    
    public CreateMWWUCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateMWWUCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCreateMWWUCommandFacade
            .getCreateMWWUCommand(this.getId());
    }
