...
public class ModuleWithoutUnitsICProxi extends ApprICProxi implements PersistentModuleWithoutUnits{
    
    public ModuleWithoutUnitsICProxi(long objectId) {
        super(objectId);
    }
    public ModuleWithoutUnitsICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theModuleWithoutUnitsFacade
            .getModuleWithoutUnits(this.getId());
    }
