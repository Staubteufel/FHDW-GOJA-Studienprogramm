...
public class StudentServerLstProxi extends PersistentProxi implements PersistentStudentServerLst{
    
    public StudentServerLstProxi(long objectId) {
        super(objectId);
    }
    public StudentServerLstProxi(PersistentInCacheProxi object) {
        super(object);
    }
