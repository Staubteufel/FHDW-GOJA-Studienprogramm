...
public class ThreeThreeProxi extends ThirdMarkProxi implements PersistentThreeThree{
    
    public ThreeThreeProxi(long objectId) {
        super(objectId);
    }
    public ThreeThreeProxi(PersistentInCacheProxi object) {
        super(object);
    }
