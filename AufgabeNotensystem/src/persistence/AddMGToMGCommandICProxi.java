...
public class AddMGToMGCommandICProxi extends PersistentInCacheProxi implements PersistentAddMGToMGCommand{
    
    public AddMGToMGCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddMGToMGCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddMGToMGCommandFacade
            .getAddMGToMGCommand(this.getId());
    }
