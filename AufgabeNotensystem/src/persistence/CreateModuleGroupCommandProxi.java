...
public class CreateModuleGroupCommandProxi extends PersistentProxi implements PersistentCreateModuleGroupCommand{
    
    public CreateModuleGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateModuleGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
