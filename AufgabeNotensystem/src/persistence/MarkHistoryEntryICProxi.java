...
public class MarkHistoryEntryICProxi extends PersistentInCacheProxiOptimistic implements PersistentMarkHistoryEntry{
    
    public MarkHistoryEntryICProxi(long objectId) {
        super(objectId);
    }
    public MarkHistoryEntryICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theMarkHistoryEntryFacade
            .getMarkHistoryEntry(this.getId());
    }
