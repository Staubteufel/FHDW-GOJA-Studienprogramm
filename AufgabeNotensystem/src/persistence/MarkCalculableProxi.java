...
public abstract class MarkCalculableProxi extends PersistentProxi implements PersistentMarkCalculable{
    
    public MarkCalculableProxi(long objectId) {
        super(objectId);
    }
    public MarkCalculableProxi(PersistentInCacheProxi object) {
        super(object);
    }
