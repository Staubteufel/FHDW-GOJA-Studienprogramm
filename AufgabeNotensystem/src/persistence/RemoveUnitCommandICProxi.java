...
public class RemoveUnitCommandICProxi extends PersistentInCacheProxi implements PersistentRemoveUnitCommand{
    
    public RemoveUnitCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemoveUnitCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemoveUnitCommandFacade
            .getRemoveUnitCommand(this.getId());
    }
