...
public class ThreeZeroICProxi extends ThirdMarkICProxi implements PersistentThreeZero{
    
    public ThreeZeroICProxi(long objectId) {
        super(objectId);
    }
    public ThreeZeroICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theThreeZeroFacade
            .getThreeZero(this.getId());
    }
