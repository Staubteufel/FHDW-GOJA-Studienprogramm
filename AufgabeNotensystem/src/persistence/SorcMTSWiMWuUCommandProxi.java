...
public class SorcMTSWiMWuUCommandProxi extends PersistentProxi implements PersistentSorcMTSWiMWuUCommand{
    
    public SorcMTSWiMWuUCommandProxi(long objectId) {
        super(objectId);
    }
    public SorcMTSWiMWuUCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
