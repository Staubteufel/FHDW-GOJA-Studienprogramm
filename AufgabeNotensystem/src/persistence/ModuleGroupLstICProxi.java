...
public class ModuleGroupLstICProxi extends PersistentInCacheProxiOptimistic implements PersistentModuleGroupLst{
    
    public ModuleGroupLstICProxi(long objectId) {
        super(objectId);
    }
    public ModuleGroupLstICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theModuleGroupLstFacade
            .getModuleGroupLst(this.getId());
    }
