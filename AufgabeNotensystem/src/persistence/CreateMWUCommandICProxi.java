...
public class CreateMWUCommandICProxi extends PersistentInCacheProxi implements PersistentCreateMWUCommand{
    
    public CreateMWUCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateMWUCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCreateMWUCommandFacade
            .getCreateMWUCommand(this.getId());
    }
