...
public class BooleanMarkICProxi extends MarkNotCalculableICProxi implements PersistentBooleanMark{
    
    public BooleanMarkICProxi(long objectId) {
        super(objectId);
    }
    public BooleanMarkICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theBooleanMarkFacade
            .getBooleanMark(this.getId());
    }
