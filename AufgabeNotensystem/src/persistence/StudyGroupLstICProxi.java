...
public class StudyGroupLstICProxi extends PersistentInCacheProxiOptimistic implements PersistentStudyGroupLst{
    
    public StudyGroupLstICProxi(long objectId) {
        super(objectId);
    }
    public StudyGroupLstICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theStudyGroupLstFacade
            .getStudyGroupLst(this.getId());
    }
