...
public class TwoZeroProxi extends ThirdMarkProxi implements PersistentTwoZero{
    
    public TwoZeroProxi(long objectId) {
        super(objectId);
    }
    public TwoZeroProxi(PersistentInCacheProxi object) {
        super(object);
    }
