...
public class AddMWUToMGCommandICProxi extends PersistentInCacheProxi implements PersistentAddMWUToMGCommand{
    
    public AddMWUToMGCommandICProxi(long objectId) {
        super(objectId);
    }
    public AddMWUToMGCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAddMWUToMGCommandFacade
            .getAddMWUToMGCommand(this.getId());
    }
