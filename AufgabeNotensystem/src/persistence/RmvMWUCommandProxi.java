...
public class RmvMWUCommandProxi extends PersistentProxi implements PersistentRmvMWUCommand{
    
    public RmvMWUCommandProxi(long objectId) {
        super(objectId);
    }
    public RmvMWUCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
