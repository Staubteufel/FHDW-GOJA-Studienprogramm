...
public class NoneMarkProxi extends MarkNotCalculableProxi implements PersistentNoneMark{
    
    public NoneMarkProxi(long objectId) {
        super(objectId);
    }
    public NoneMarkProxi(PersistentInCacheProxi object) {
        super(object);
    }
