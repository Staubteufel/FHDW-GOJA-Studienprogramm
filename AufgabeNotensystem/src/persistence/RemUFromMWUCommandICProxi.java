...
public class RemUFromMWUCommandICProxi extends PersistentInCacheProxi implements PersistentRemUFromMWUCommand{
    
    public RemUFromMWUCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemUFromMWUCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemUFromMWUCommandFacade
            .getRemUFromMWUCommand(this.getId());
    }
