...
public class RemoveModuleGroupCommandProxi extends PersistentProxi implements PersistentRemoveModuleGroupCommand{
    
    public RemoveModuleGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public RemoveModuleGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
