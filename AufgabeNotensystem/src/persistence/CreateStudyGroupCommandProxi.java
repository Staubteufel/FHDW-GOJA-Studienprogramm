...
public class CreateStudyGroupCommandProxi extends PersistentProxi implements PersistentCreateStudyGroupCommand{
    
    public CreateStudyGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public CreateStudyGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
