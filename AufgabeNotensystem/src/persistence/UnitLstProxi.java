...
public class UnitLstProxi extends PersistentProxi implements PersistentUnitLst{
    
    public UnitLstProxi(long objectId) {
        super(objectId);
    }
    public UnitLstProxi(PersistentInCacheProxi object) {
        super(object);
    }
