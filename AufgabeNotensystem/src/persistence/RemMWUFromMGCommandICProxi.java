...
public class RemMWUFromMGCommandICProxi extends PersistentInCacheProxi implements PersistentRemMWUFromMGCommand{
    
    public RemMWUFromMGCommandICProxi(long objectId) {
        super(objectId);
    }
    public RemMWUFromMGCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRemMWUFromMGCommandFacade
            .getRemMWUFromMGCommand(this.getId());
    }
