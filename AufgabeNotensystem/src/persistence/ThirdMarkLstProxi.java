...
public class ThirdMarkLstProxi extends PersistentProxi implements PersistentThirdMarkLst{
    
    public ThirdMarkLstProxi(long objectId) {
        super(objectId);
    }
    public ThirdMarkLstProxi(PersistentInCacheProxi object) {
        super(object);
    }
