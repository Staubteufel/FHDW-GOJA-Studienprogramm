...
public class FiveZeroProxi extends ThirdMarkProxi implements PersistentFiveZero{
    
    public FiveZeroProxi(long objectId) {
        super(objectId);
    }
    public FiveZeroProxi(PersistentInCacheProxi object) {
        super(object);
    }
