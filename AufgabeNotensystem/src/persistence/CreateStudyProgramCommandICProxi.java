...
public class CreateStudyProgramCommandICProxi extends PersistentInCacheProxi implements PersistentCreateStudyProgramCommand{
    
    public CreateStudyProgramCommandICProxi(long objectId) {
        super(objectId);
    }
    public CreateStudyProgramCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theCreateStudyProgramCommandFacade
            .getCreateStudyProgramCommand(this.getId());
    }
