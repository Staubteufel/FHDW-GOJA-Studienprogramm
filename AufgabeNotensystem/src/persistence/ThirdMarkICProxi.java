...
public class ThirdMarkICProxi extends MarkCalculableICProxi implements PersistentThirdMark{
    
    public ThirdMarkICProxi(long objectId) {
        super(objectId);
    }
    public ThirdMarkICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theThirdMarkFacade
            .getThirdMark(this.getId());
    }
