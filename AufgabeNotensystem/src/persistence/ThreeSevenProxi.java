...
public class ThreeSevenProxi extends ThirdMarkProxi implements PersistentThreeSeven{
    
    public ThreeSevenProxi(long objectId) {
        super(objectId);
    }
    public ThreeSevenProxi(PersistentInCacheProxi object) {
        super(object);
    }
