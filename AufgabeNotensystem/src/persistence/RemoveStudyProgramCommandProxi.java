...
public class RemoveStudyProgramCommandProxi extends PersistentProxi implements PersistentRemoveStudyProgramCommand{
    
    public RemoveStudyProgramCommandProxi(long objectId) {
        super(objectId);
    }
    public RemoveStudyProgramCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
