...
public class TwoSevenICProxi extends ThirdMarkICProxi implements PersistentTwoSeven{
    
    public TwoSevenICProxi(long objectId) {
        super(objectId);
    }
    public TwoSevenICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theTwoSevenFacade
            .getTwoSeven(this.getId());
    }
