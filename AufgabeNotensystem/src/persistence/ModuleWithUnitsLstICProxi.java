...
public class ModuleWithUnitsLstICProxi extends PersistentInCacheProxiOptimistic implements PersistentModuleWithUnitsLst{
    
    public ModuleWithUnitsLstICProxi(long objectId) {
        super(objectId);
    }
    public ModuleWithUnitsLstICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theModuleWithUnitsLstFacade
            .getModuleWithUnitsLst(this.getId());
    }
