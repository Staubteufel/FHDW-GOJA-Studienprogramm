...
public class SorcMTSWiUCommandICProxi extends PersistentInCacheProxi implements PersistentSorcMTSWiUCommand{
    
    public SorcMTSWiUCommandICProxi(long objectId) {
        super(objectId);
    }
    public SorcMTSWiUCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theSorcMTSWiUCommandFacade
            .getSorcMTSWiUCommand(this.getId());
    }
