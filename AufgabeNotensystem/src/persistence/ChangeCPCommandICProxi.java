...
public class ChangeCPCommandICProxi extends PersistentInCacheProxi implements PersistentChangeCPCommand{
    
    public ChangeCPCommandICProxi(long objectId) {
        super(objectId);
    }
    public ChangeCPCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theChangeCPCommandFacade
            .getChangeCPCommand(this.getId());
    }
