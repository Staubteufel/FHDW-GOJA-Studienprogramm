...
public class OneZeroProxi extends ThirdMarkProxi implements PersistentOneZero{
    
    public OneZeroProxi(long objectId) {
        super(objectId);
    }
    public OneZeroProxi(PersistentInCacheProxi object) {
        super(object);
    }
