...
public class RemMWWUFromMGCommandProxi extends PersistentProxi implements PersistentRemMWWUFromMGCommand{
    
    public RemMWWUFromMGCommandProxi(long objectId) {
        super(objectId);
    }
    public RemMWWUFromMGCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
