...
public abstract class PrototypeICProxi extends PersistentInCacheProxiOptimistic implements PersistentPrototype{
    
    public PrototypeICProxi(long objectId) {
        super(objectId);
    }
    public PrototypeICProxi(PersistentObject object) {
        super(object);
    }
