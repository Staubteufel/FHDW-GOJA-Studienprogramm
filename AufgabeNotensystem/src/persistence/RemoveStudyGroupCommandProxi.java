...
public class RemoveStudyGroupCommandProxi extends PersistentProxi implements PersistentRemoveStudyGroupCommand{
    
    public RemoveStudyGroupCommandProxi(long objectId) {
        super(objectId);
    }
    public RemoveStudyGroupCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
