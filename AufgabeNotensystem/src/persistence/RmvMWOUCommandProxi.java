...
public class RmvMWOUCommandProxi extends PersistentProxi implements PersistentRmvMWOUCommand{
    
    public RmvMWOUCommandProxi(long objectId) {
        super(objectId);
    }
    public RmvMWOUCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
