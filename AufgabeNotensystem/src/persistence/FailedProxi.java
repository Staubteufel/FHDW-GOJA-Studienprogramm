...
public class FailedProxi extends BooleanMarkProxi implements PersistentFailed{
    
    public FailedProxi(long objectId) {
        super(objectId);
    }
    public FailedProxi(PersistentInCacheProxi object) {
        super(object);
    }
