...
public class AdminServerICProxi extends ServiceICProxi implements PersistentAdminServer{
    
    public AdminServerICProxi(long objectId) {
        super(objectId);
    }
    public AdminServerICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theAdminServerFacade
            .getAdminServer(this.getId());
    }
