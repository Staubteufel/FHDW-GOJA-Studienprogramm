...
public class FourZeroProxi extends ThirdMarkProxi implements PersistentFourZero{
    
    public FourZeroProxi(long objectId) {
        super(objectId);
    }
    public FourZeroProxi(PersistentInCacheProxi object) {
        super(object);
    }
