...
public class ThirdMarkProxi extends MarkCalculableProxi implements ThirdMarkView{
    
    public ThirdMarkProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ThirdMarkView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ThirdMarkView result$$ = new ThirdMark( this.getId(), this.getClassId());
