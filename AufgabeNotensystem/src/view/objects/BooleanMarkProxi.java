...
public class BooleanMarkProxi extends MarkNotCalculableProxi implements BooleanMarkView{
    
    public BooleanMarkProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public BooleanMarkView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        BooleanMarkView result$$ = new BooleanMark( this.getId(), this.getClassId());
