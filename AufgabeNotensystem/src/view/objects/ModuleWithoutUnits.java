...
public class ModuleWithoutUnits extends view.objects.Appr implements ModuleWithoutUnitsView{
    
    
    public ModuleWithoutUnits(String name,java.util.Vector<MarkHistoryEntryView> markHistory,common.Fraction creditPoints,long id, long classId) {
