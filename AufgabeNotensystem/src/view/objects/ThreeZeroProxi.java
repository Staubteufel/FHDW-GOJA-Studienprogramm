...
public class ThreeZeroProxi extends ThirdMarkProxi implements ThreeZeroView{
    
    public ThreeZeroProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ThreeZeroView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ThreeZeroView result$$ = new ThreeZero( this.getId(), this.getClassId());
