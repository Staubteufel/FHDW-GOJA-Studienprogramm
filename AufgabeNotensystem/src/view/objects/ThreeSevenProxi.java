...
public class ThreeSevenProxi extends ThirdMarkProxi implements ThreeSevenView{
    
    public ThreeSevenProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ThreeSevenView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ThreeSevenView result$$ = new ThreeSeven( this.getId(), this.getClassId());
