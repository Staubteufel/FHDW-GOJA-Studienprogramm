...
public class FiveZeroProxi extends ThirdMarkProxi implements FiveZeroView{
    
    public FiveZeroProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public FiveZeroView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        FiveZeroView result$$ = new FiveZero( this.getId(), this.getClassId());
