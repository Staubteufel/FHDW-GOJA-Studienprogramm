...
public class OneZeroProxi extends ThirdMarkProxi implements OneZeroView{
    
    public OneZeroProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public OneZeroView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        OneZeroView result$$ = new OneZero( this.getId(), this.getClassId());
