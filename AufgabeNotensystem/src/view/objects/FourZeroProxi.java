...
public class FourZeroProxi extends ThirdMarkProxi implements FourZeroView{
    
    public FourZeroProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public FourZeroView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        FourZeroView result$$ = new FourZero( this.getId(), this.getClassId());
