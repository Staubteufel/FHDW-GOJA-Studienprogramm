...
public class UnitProxi extends ApprProxi implements UnitView{
    ...
    public UnitView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        UnitView result$$ = new Unit((String)name,markHistory,(common.Fraction)creditPoints, this.getId(), this.getClassId());
