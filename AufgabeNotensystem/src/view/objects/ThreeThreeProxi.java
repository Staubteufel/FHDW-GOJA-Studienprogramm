...
public class ThreeThreeProxi extends ThirdMarkProxi implements ThreeThreeView{
    
    public ThreeThreeProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ThreeThreeView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ThreeThreeView result$$ = new ThreeThree( this.getId(), this.getClassId());
