...
public class NotAllowedOperationOnPrototypeException extends model.UserException{
    ...
    public NotAllowedOperationOnPrototypeException(String message) throws PersistenceException {
        super(message);        
    }
