...
public class Server extends PersistentObject implements PersistentServer{
    ...
    public java.util.HashMap<String,Object> toHashtable(java.util.HashMap<String,Object> allResults, int depth, int essentialLevel, boolean forGUI, boolean leaf, boolean inDerived) throws PersistenceException {
        ...
        if (depth > 0 && essentialLevel <= common.RPCConstantsAndServices.EssentialDepth){
            ...
            result.put("services", this.getServices().getVector(allResults, depth, essentialLevel, forGUI, false, true, inDerived, false, false));
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == -141) ConnectionHandler.getTheConnectionHandler().theServerFacade
    ...
    public void initializeOnCreation() 
    	...
    	if(getThis().getUser().equals(common.RPCConstantsAndServices.AdministratorName)) {
    		getThis().getServices().add(AdminServer.createAdminServer());
    	}
    	else {
    		StudentServer4Public student = StudentServerLst.getTheStudentServerLst().getStudentServers().get(getUser());
    		getThis().getServices().add(student);
    	}
    }
