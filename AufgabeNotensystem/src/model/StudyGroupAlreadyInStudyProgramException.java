...
public class StudyGroupAlreadyInStudyProgramException extends model.UserException{
    ...
    public StudyGroupAlreadyInStudyProgramException(String message) throws PersistenceException {
        super(message);        
    }
