...
public class ThereIsAlreadyAStudyGroupException extends model.UserException{
    ...
    public ThereIsAlreadyAStudyGroupException(String message) throws PersistenceException {
        super(message);        
    }
