...
public class TwoThree extends model.ThirdMark implements PersistentTwoThree{
    
    private static TwoThree4Public theTwoThree = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static TwoThree4Public getTheTwoThree() throws PersistenceException{
        if (theTwoThree == null || reset$For$Test){
            if (reset$For$Test) theTwoThree = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            TwoThree4Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theTwoThreeFacade.getTheTwoThree();
                            theTwoThree = proxi;
                            if(proxi.getId() < 0) {
                ...
                TwoThree4Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theTwoThree== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public TwoThree provideCopy() throws PersistenceException{
        TwoThree result = this;
        result = new TwoThree(this.value, 
                              this.This, 
                              this.getId());
    ...
    public TwoThree(common.Fraction value,PersistentMarkCalculable This,long id) throws PersistenceException {
    ...
    public PersistentTwoThree getThis() throws PersistenceException {
        if(this.This == null){
            PersistentTwoThree result = (PersistentTwoThree)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentTwoThree)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
        ...
        this.setThis((PersistentTwoThree)This);
    ...
    public void initializeOnCreation() 
        ...
        getThis().setValue(new Fraction(BigInteger.valueOf(23), BigInteger.valueOf(10)));
    }
