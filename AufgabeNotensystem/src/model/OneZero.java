...
public class OneZero extends model.ThirdMark implements PersistentOneZero{
    
    private static OneZero4Public theOneZero = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static OneZero4Public getTheOneZero() throws PersistenceException{
        if (theOneZero == null || reset$For$Test){
            if (reset$For$Test) theOneZero = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            OneZero4Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theOneZeroFacade.getTheOneZero();
                            theOneZero = proxi;
                            if(proxi.getId() < 0) {
                ...
                OneZero4Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theOneZero== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public OneZero provideCopy() throws PersistenceException{
        OneZero result = this;
        result = new OneZero(this.value, 
                             this.This, 
                             this.getId());
    ...
    public OneZero(common.Fraction value,PersistentMarkCalculable This,long id) throws PersistenceException {
    ...
    public PersistentOneZero getThis() throws PersistenceException {
        if(this.This == null){
            PersistentOneZero result = (PersistentOneZero)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentOneZero)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
        ...
        this.setThis((PersistentOneZero)This);
    ...
    public void initializeOnCreation() 
        ...
        getThis().setValue(new Fraction(BigInteger.valueOf(1), BigInteger.valueOf(1)));
    }
