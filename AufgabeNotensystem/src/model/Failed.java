...
public class Failed extends model.BooleanMark implements PersistentFailed{
    
    private static Failed4Public theFailed = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static Failed4Public getTheFailed() throws PersistenceException{
        if (theFailed == null || reset$For$Test){
            if (reset$For$Test) theFailed = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            Failed4Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theFailedFacade.getTheFailed();
                            theFailed = proxi;
                            if(proxi.getId() < 0) {
                ...
                Failed4Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theFailed== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public Failed provideCopy() throws PersistenceException{
        Failed result = this;
        result = new Failed(this.This, 
                            this.getId());
    ...
    public Failed(PersistentMarkNotCalculable This,long id) throws PersistenceException {
    ...
    public PersistentFailed getThis() throws PersistenceException {
        if(this.This == null){
            PersistentFailed result = (PersistentFailed)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentFailed)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
        ...
        this.setThis((PersistentFailed)This);
