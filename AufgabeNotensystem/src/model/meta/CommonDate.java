...
public class CommonDate extends PersistentObject implements PersistentCommonDate{
    ...
    public CommonDate(java.sql.Date createDate,java.sql.Date commitDate,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 122) ConnectionHandler.getTheConnectionHandler().theCommonDateFacade
