...
public class FourZero extends model.ThirdMark implements PersistentFourZero{
    
    private static FourZero4Public theFourZero = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static FourZero4Public getTheFourZero() throws PersistenceException{
        if (theFourZero == null || reset$For$Test){
            if (reset$For$Test) theFourZero = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            FourZero4Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theFourZeroFacade.getTheFourZero();
                            theFourZero = proxi;
                            if(proxi.getId() < 0) {
                ...
                FourZero4Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theFourZero== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public FourZero provideCopy() throws PersistenceException{
        FourZero result = this;
        result = new FourZero(this.value, 
                              this.This, 
                              this.getId());
    ...
    public FourZero(common.Fraction value,PersistentMarkCalculable This,long id) throws PersistenceException {
    ...
    public PersistentFourZero getThis() throws PersistenceException {
        if(this.This == null){
            PersistentFourZero result = (PersistentFourZero)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentFourZero)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
        ...
        this.setThis((PersistentFourZero)This);
    ...
    public void initializeOnCreation() 
        ...
        getThis().setValue(new Fraction(BigInteger.valueOf(4), BigInteger.valueOf(1)));
    }
