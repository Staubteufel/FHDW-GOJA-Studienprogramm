...
public class TwoSeven extends model.ThirdMark implements PersistentTwoSeven{
    
    private static TwoSeven4Public theTwoSeven = null;
    public static boolean reset$For$Test = false;
    private static final Object $$lock = new Object();
    public static TwoSeven4Public getTheTwoSeven() throws PersistenceException{
        if (theTwoSeven == null || reset$For$Test){
            if (reset$For$Test) theTwoSeven = null;
            class Initializer implements Runnable {
                ...
                void produceSingleton() {
                    synchronized ($$lock){
                        try {
                            TwoSeven4Public proxi = null;
                            proxi = ConnectionHandler.getTheConnectionHandler().theTwoSevenFacade.getTheTwoSeven();
                            theTwoSeven = proxi;
                            if(proxi.getId() < 0) {
                ...
                TwoSeven4Public getResult() throws PersistenceException{
                    synchronized ($$lock) {
                        if (exception == null && theTwoSeven== null) try {$$lock.wait();} catch (InterruptedException e) {}
    ...
    public TwoSeven provideCopy() throws PersistenceException{
        TwoSeven result = this;
        result = new TwoSeven(this.value, 
                              this.This, 
                              this.getId());
    ...
    public TwoSeven(common.Fraction value,PersistentMarkCalculable This,long id) throws PersistenceException {
    ...
    public PersistentTwoSeven getThis() throws PersistenceException {
        if(this.This == null){
            PersistentTwoSeven result = (PersistentTwoSeven)PersistentProxi.createProxi(this.getId(),this.getClassId());
            result.getTheObject();
            return result;
        }return (PersistentTwoSeven)this.This;
    }
    ...
    public void initialize(final Anything This, final java.util.HashMap<String,Object> final$$Fields) 
        ...
        this.setThis((PersistentTwoSeven)This);
    ...
    public void initializeOnCreation() 
        ...
        getThis().setValue(new Fraction(BigInteger.valueOf(27), BigInteger.valueOf(10)));
    }
