...
public class UnitIsAlreadyPartOfAModuleWithUnitsException extends model.UserException{
    ...
    public UnitIsAlreadyPartOfAModuleWithUnitsException(String message) throws PersistenceException {
        super(message);        
    }
