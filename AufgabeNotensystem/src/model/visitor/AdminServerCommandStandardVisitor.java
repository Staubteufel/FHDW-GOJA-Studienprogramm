...
public abstract class AdminServerCommandStandardVisitor implements AdminServerCommandVisitor {
    ...
    protected abstract void standardHandling(AdminServerCommand adminServerCommand) throws PersistenceException;
}
