...
public class TestSupport {
	...
	private static final File ModelDirectory = new File("C:\\Users\\admin\\GOJAEnvironment\\Models\\AufgabeNotensystem"); 

	//Manual path start
	private static final File GojaDirectory = ModelDirectory;
	...
	public static void prepareSingletons(){
        ...
        model.MarkFactory.reset$For$Test = true;
        model.ThirdMarkLst.reset$For$Test = true;
        model.StudyGroupLst.reset$For$Test = true;
        model.ModuleGroupLst.reset$For$Test = true;
        model.FiveZero.reset$For$Test = true;
        model.meta.CommandCoordinator.reset$For$Test = true;
        model.TwoZero.reset$For$Test = true;
        model.Failed.reset$For$Test = true;
        model.UnitLst.reset$For$Test = true;
        model.ThreeSeven.reset$For$Test = true;
        model.ModuleWithUnitsLst.reset$For$Test = true;
        model.StudentServerLst.reset$For$Test = true;
        model.ThreeZero.reset$For$Test = true;
        model.TwoSeven.reset$For$Test = true;
        model.OneSeven.reset$For$Test = true;
        model.ThreeThree.reset$For$Test = true;
        model.OneThree.reset$For$Test = true;
        model.TwoThree.reset$For$Test = true;
        model.FourZero.reset$For$Test = true;
        model.OneZero.reset$For$Test = true;
        model.StudyProgramLst.reset$For$Test = true;
        model.ModuleWithoutUnitsLst.reset$For$Test = true;
        model.BooleanMarkLst.reset$For$Test = true;
